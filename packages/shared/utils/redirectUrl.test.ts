...
describe("validateRedirectUrl", () => {
  ...
  it("should allow library:// scheme for mobile app", () => {
    expect(validateRedirectUrl("library://")).toBe("library://");
    expect(validateRedirectUrl("library://callback")).toBe(
      "library://callback",
    );
    expect(validateRedirectUrl("library://callback/path")).toBe(
      "library://callback/path",
    );
    expect(validateRedirectUrl("library://callback?param=value")).toBe(
      "library://callback?param=value",
    );
  });
...
describe("isMobileAppRedirect", () => {
  it("should return true for library:// URLs", () => {
    expect(isMobileAppRedirect("library://")).toBe(true);
    expect(isMobileAppRedirect("library://callback")).toBe(true);
    expect(isMobileAppRedirect("library://callback/path")).toBe(true);
  });
