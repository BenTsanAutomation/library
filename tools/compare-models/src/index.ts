...
import { LibraryAPIClient } from "./apiClient";
...
async function main() {
  ...
  const apiClient = new LibraryAPIClient();

  displayProgress("Fetching bookmarks from Library...");
