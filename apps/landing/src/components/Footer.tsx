...
const footerLinks = {
  Product: [
    ...
    { label: "Try Demo", href: "https://try.library.example.com" },
    { label: "Library Cloud", href: "https://cloud.library.example.com" },
  ],
  Resources: [
    ...
    { label: "API Reference", href: `${DOCS_LINK}/api/library-api` },
  ],
  Legal: [
...
export default function Footer() {
  return (
    <footer className="border-t border-stone-200 bg-[#f7f3ec] px-4 py-14">
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            <img src={Logo} alt="Library" className="w-32" loading="lazy" />
            <p className="mt-3 text-sm leading-6 text-stone-500">
              A calmer bookmark library for the links, notes, images, and ideas
