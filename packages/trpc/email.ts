...
import { getTracer, withSpan } from "@library/shared-server";
import serverConfig from "@library/shared/config";

const tracer = getTracer("@library/trpc");
...
export const sendInviteEmail = withTracing(
  ...
  async (
    ...
    const mailOptions = {
      from: serverConfig.email.smtp!.from,
      to: email,
      subject: "You've been invited to join Library",
      html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2>You've been invited to join Library!</h2>
        <p>${inviterName} has invited you to join Library, the bookmark everything app.</p>
    ...
    `,
      text: `
You've been invited to join Library!

${inviterName} has invited you to join Library, a powerful bookmarking and content organization platform.
  ...
  async (
    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Hi ${name},</p>
        <p>You requested to reset your password for your Library account. Click the link below to reset your password:</p>
        <p>
...
You requested to reset your password for your Library account. Visit this link to reset your password:
${resetUrl}
  ...
  async (
    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>${inviterName} has invited you to collaborate on the list <strong>"${listName}"</strong> in Library.</p>
        ...
        <p>If the button doesn't work, you can copy and paste this link into your browser:</p>
        <p><a href="${inviteUrl}">${inviteUrl}</a></p>
        <p>You can accept or decline this invitation from your Library dashboard.</p>
...
${inviterName} has invited you to collaborate on the list "${listName}" in Library.

View your invitation by visiting this link:
${inviteUrl}

You can accept or decline this invitation from your Library dashboard.
