...
import type { ZAttachedByEnum } from "@library/shared/types/tags";
import { SqliteError } from "@library/db";
import { bookmarkTags, tagsOnBookmarks } from "@library/db/schema";
import { triggerSearchReindex } from "@library/shared-server";
import {
  zCreateTagRequestSchema,
  zGetTagResponseSchema,
  zTagBasicSchema,
  zUpdateTagRequestSchema,
} from "@library/shared/types/tags";
import { switchCase } from "@library/shared/utils/switch";
