...
import { zSignUpSchema } from "@library/shared/types/users";
import { isMobileAppRedirect } from "@library/shared/utils/redirectUrl";
  ...
  return (
    <Card className="w-full">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Join Library to start organizing your bookmarks
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <Form {...form}>
