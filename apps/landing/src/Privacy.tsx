  ...
  return (
    <div className="mx-auto max-w-3xl p-4">
      <main className="space-y-6">
        ...
        <p className="rounded border border-yellow-300 bg-yellow-50 p-3 text-sm leading-relaxed text-gray-800">
          Forked from Library (library.example.com). Personal-use deployment. This
          privacy policy is inherited from upstream and may not reflect actual
          data practices of this fork — review before relying on it.
        </p>
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          share it for Library Cloud. Localhost Labs Ltd is the data controller
          for personal data processed under this policy. Library Cloud is
        ...
        <p className="text-base leading-relaxed text-gray-700">
          We use your data to run and improve Library Cloud, including to:
        </p>
        <ul className="ml-6 list-disc space-y-2 text-gray-700">
        ...
        <p className="text-base leading-relaxed text-gray-700">
          We use subprocessors to run Library Cloud. They only process data on
        ...
        <p className="text-base leading-relaxed text-gray-700">
          Library Cloud stores primary data in Europe. Some subprocessors may
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          or support@library.example.com. We respond within timelines required by
          applicable law.
        </p>

        <h2 className="text-lg font-semibold text-gray-900">11. Children</h2>
        <p className="text-base leading-relaxed text-gray-700">
          Library Cloud is not intended for children under 16. If you believe a
        ...
        <p className="text-base leading-relaxed text-gray-700">
          The Library browser extension works with your Library account. It
          ...
          only to Library Cloud and is not shared with third parties. Content
        ...
        <p className="text-base leading-relaxed text-gray-700">
          This policy applies to Library Cloud. If you self-host Library, your
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          Support:{" "}
          <a
            href="mailto:support@library.example.com"
            className="text-blue-600 hover:underline"
          >
            support@library.example.com
          </a>
        </p>
      </main>
    </div>
