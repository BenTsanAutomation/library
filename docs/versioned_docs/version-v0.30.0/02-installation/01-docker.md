...
For example you could make a new directory called "your-org" with the following command:
```
mkdir your-org
```
...
Download the docker compose file provided [here](https://github.com/your-org/library/blob/main/docker/docker-compose.yml) directly into your new directory.

```
wget https://raw.githubusercontent.com/your-org/library/main/docker/docker-compose.yml
```
...
Updating Library will depend on what you used for the `LIBRARY_VERSION` env variable.
...
- If you used `LIBRARY_VERSION=release`, you'll need to force docker to pull the latest version by running `docker compose up --pull always -d`.
