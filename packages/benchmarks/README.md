...
This package spins up a production-like Library stack in Docker, seeds it with a sizeable dataset, then benchmarks a handful of high-signal APIs.

## Usage

```bash
pnpm --filter @library/benchmarks bench
```
