...
import { apiKeys } from "@library/db/schema";
import { API_KEY_FULL_ACCESS_SCOPE } from "@library/shared/types/apiKeys";
...
describe("API Keys Routes", () => {
  ...
  describe("exchange", () => {
    ...
    test<CustomTestContext>("rejects unverified user when email verification is enabled", async ({
      ...
      const originalConfig = (await import("@library/shared/config")).default;
      vi.spyOn(
        originalConfig.auth,
