...
const mobileApps: Listing[] = [
  {
    ...
    url: "https://apps.apple.com/us/app/your-org/id6479258022",
    badge: appleIcon,
  },
  {
    name: "Android App",
    description: "Capture and organize content on Android devices.",
    url: "https://play.google.com/store/apps/details?id=app.library.librarymobile&pcampaignid=web_share",
...
const browserExtensions: Listing[] = [
  {
    ...
    url: "https://chromewebstore.google.com/detail/library/kgcjekpmcjjogibpjebkhaanilehneje",
    badge: chromeIcon,
  },
  {
    name: "Firefox Add-on",
    description: "Save pages directly from Firefox.",
    url: "https://addons.mozilla.org/en-US/firefox/addon/library/",
    badge: firefoxIcon,
  },
];
...
const communityProjects: Listing[] = [
  {
    ...
    description: "Manage your Library bookmarks directly from Raycast.",
    url: "https://www.raycast.com/luolei/library",
    badge: raycastIcon,
  },
  {
    name: "Obsidian Plugin",
    description: "Sync your Library bookmarks to Obsidian as markdown notes.",
    url: "https://obsidian.md/plugins?id=library-sync",
    badge: obsidianIcon,
  },
];
    ...
    <div className="container mx-auto pb-16">
      <main className="px-4 py-8 sm:px-6 sm:py-14">
        ...
        <p className="mt-3 max-w-2xl text-base text-gray-600 sm:text-lg">
          Use Library anywhere with our mobile apps and browser extensions.
        </p>
        <div className="mt-10 space-y-6">
          ...
          <ListingSection
            ...
            description="Integrations built by the Library community."
