...
This guide explains how to migrate all of your data from one Library server to another using the official CLI.
...
- Install the CLI:
  - NPM: `npm install -g @library/cli`
  - Docker: `docker run --rm ghcr.io/your-org/library-cli:release --help`
...
```
library --server-addr https://src.example.com --api-key <SOURCE_API_KEY> migrate \
