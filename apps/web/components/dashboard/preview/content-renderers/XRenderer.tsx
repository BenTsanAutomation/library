...
// react-tweet ships its own CSS — without this import the embedded tweet
// renders unstyled (no layout, near-invisible text), which looks identical
// to "blank preview" inside the dashboard's dark/light surfaces.
