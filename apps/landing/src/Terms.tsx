    ...
    <div className="mx-auto max-w-3xl p-4">
      <main className="space-y-6">
        ...
        <p className="rounded border border-yellow-300 bg-yellow-50 p-3 text-sm leading-relaxed text-gray-800">
          Forked from Library (library.example.com). Personal-use deployment. These
          terms are inherited from upstream and may not reflect actual practices
          of this fork — review before relying on it.
        </p>
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          Library Cloud (&ldquo;Service&rdquo;), operated by Localhost Labs Ltd
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          Library Cloud (including search and tagging features), and you need
        ...
        <p className="text-base leading-relaxed text-gray-700">
          Library Cloud is a hosted bookmarking and content-saving service that
          ...
          version of Library. Self-hosted instances of Library are governed by
        ...
        <p className="text-base leading-relaxed text-gray-700">
          Access to the Library API is governed by these Terms. We may impose
        ...
        <p className="text-base leading-relaxed text-gray-700">
          The Library name, logo, and service features are the property of
          Localhost Labs Ltd. The open-source code that powers Library is
