  ...
  const detailsSection = (
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-1">
        ...
        {sourceUrl && (
          <Link
            href={sourceUrl}
            target="_blank"
            className="library-detail-link flex items-center gap-1 text-xs"
          >
      ...
      <div className="flex flex-col gap-1.5">
        <p className="library-detail-label text-xs font-medium uppercase tracking-wide">
          {t("common.tags")}
        </p>
    ...
    <>
      ...
      <div className="hidden h-full flex-col overflow-hidden bg-background lg:flex">
        <div className="flex min-h-0 flex-1">
          ...
          {!sidebarCollapsed && (
            <div className="library-detail-panel flex w-1/3 flex-col gap-3 overflow-auto border-l border-white/5 p-5">
              {detailsSection}
            </div>
          )}
        </div>
      ...
      <div className="flex h-full w-full flex-col overflow-hidden lg:hidden">
        ...
        >
          ...
          <TabsContent
            value="details"
            className="library-detail-panel h-full overflow-y-auto px-4 py-3 data-[state=inactive]:hidden"
          >
            {detailsSection}
          </TabsContent>
        </Tabs>
