...
import type { ZPrompt } from "@library/shared/types/prompts";
import type { RuleEngineRule } from "@library/shared/types/rules";
import type { ZGetTagResponse } from "@library/shared/types/tags";
import {
  BookmarkTypes,
...
export const migrateCmd = new Command()
  ...
  .action(async (opts) => {
    ...
    try {
      line("");
      line(`${chalk.bold("Library Migration")}`);
