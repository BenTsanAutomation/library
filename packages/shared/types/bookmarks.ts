...
export const zBookmarkContentTypeSchema = z.enum([
  "article",
  "product",
  "book",
  "recipe",
...
export type ZBookmarkContentType = z.infer<typeof zBookmarkContentTypeSchema>;
...
export const zBareBookmarkSchema = z.object({
  ...
  contentType: zBookmarkContentTypeSchema.nullish(),
