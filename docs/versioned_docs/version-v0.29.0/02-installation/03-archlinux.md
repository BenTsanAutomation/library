...
3. Set up
    ...
    Environment variables can be set in `/etc/library/library.env` according to [configuration page](/configuration). **The environment variables that are not specified in `/etc/library/library.env` need to be added by yourself.**
...
**6. Set Library**  
Edit `/etc/library/library.env` according to [configuration page](/configuration). **The environment variables that are not specified in `/etc/library/library.env` need to be added by yourself.**
