...
import type { AssetPreprocessingRequest } from "@library/shared-server";
...
import { newAssetId, readAsset, saveAsset } from "@library/shared/assetdb";
...
import { buildOCRPrompt } from "@library/shared/prompts";
import {
  DequeuedJob,
  EnqueueOptions,
  getQueueClient,
