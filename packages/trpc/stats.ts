...
import { assets, bookmarks, subscriptions, users } from "@library/db/schema";
import {
...
const subscriptionStatusGauge = serverConfig.stripe.isConfigured
  ? new Gauge({
      name: "library_subscription_status",
...
const totalAssetSizeGauge = new Gauge({
  name: "library_total_asset_size_bytes",
...
const bookmarkCreationCounter = new Counter({
  name: "library_bookmark_creations_total",
