...
_By [@lmgarret](https://github.com/lmgarret)_
 ...
 A Docker sidecar that automatically cleans up Library bookmarks based on declarative YAML rules.
...
A terminal user interface for Library. Supports keyboard driven tag and list management of bookmarks, with suggestions populated from your server.
